	...
	<style>
		...
		.table-wrapper {
			...
			background-image:
				...
				linear-gradient(to right, white, white),
				linear-gradient(to right, rgba(0, 0, 20, .30), rgba(255, 255, 255, 0)),
				linear-gradient(to left, rgba(0, 0, 20, .30), rgba(255, 255, 255, 0));
...
export default function({ html, autoHeight, defaultHeight = 200 }) {
	const webviewRef = React.useRef(null);
	const [webViewHeight, setWebViewHeight] = React.useState(defaultHeight);
